...
class WalletTest (BitcoinTestFramework):
    ...
    def run_test (self):
        ...
        # Send 101 BTC from 0 to 2 using sendtoaddress call.
        ...
        assert_equal(self.nodes[0].getbalance(), 250-101)
        ...
        self.sync_all()
        assert_equal(self.nodes[2].getbalance(), Decimal('239.99900000'))
        ...
        self.nodes[2].generate(1)
        self.sync_all()
        assert_equal(self.nodes[2].getbalance(), Decimal('229.99900000'))
        ...
        self.nodes[2].generate(1)
        self.sync_all()
        assert_equal(self.nodes[2].getbalance(), Decimal('219.99800000'))
        ...
        self.nodes[2].generate(1)
        self.sync_all()
        assert_equal(self.nodes[2].getbalance(), Decimal('209.99800000'))
        ...
        self.sync_all()
        assert_equal(self.nodes[2].getbalance(), Decimal('209.99800000')); #should not be changed because tx was not broadcasted
        assert_equal(self.nodes[2].getbalance("*"), Decimal('209.99800000')); #should not be changed because tx was not broadcasted
        ...
        self.sync_all()
        txObjNotBroadcasted = self.nodes[0].gettransaction(txIdNotBroadcasted)
        assert_equal(self.nodes[2].getbalance(), Decimal('211.99800000')); #should not be
        assert_equal(self.nodes[2].getbalance("*"), Decimal('211.99800000')); #should not be
        ...
        assert_equal(self.nodes[2].getbalance(), Decimal('213.99800000')); #should not be
        assert_equal(self.nodes[2].getbalance("*"), Decimal('213.99800000')); #should not be
        ...
        node2utxobalance = Decimal('223.998') - zsendmanynotevalue - zsendmanyfee
