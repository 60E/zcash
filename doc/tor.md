...
In a typical situation, where you're only reachable via Tor, this should suffice:
	...
	./hcashd -proxy=127.0.0.1:9050 -externalip=zctestseie6wxgio.onion -listen
...
for normal IPv4/IPv6 communication, use:
	...
	./hcashd -onion=127.0.0.1:9050 -externalip=zctestseie6wxgio.onion -discover
...
Now use hcash-cli to verify there is only a single peer connection.

	hcash-cli getpeerinfo
